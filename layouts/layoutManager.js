...
var Extension, ExtensionUtils, LayoutManager, Main, WindowManager, Wnck, delay, helper, runGjsScript, spawn, spawnSync, wm;
...
LayoutManager = (function() {
  ...
  LayoutManager.prototype.apply = function(layoutName, filter, activeWindow) {
    var areas, avaliableHeight, avaliableWidth, currentWorkspace, layout, monitor, refocus, setGeometry, updateWindows, windows, xids;
