...
WindowManager = (function() {
  function WindowManager() {
    ...
    screen.force_update();
    this.activeWindow = screen.get_active_window();
    this.activeWorkspace = screen.get_active_workspace();
    this.windows = screen.get_windows();
    screen.connect("window-closed", (function(_this) {
    ...
    screen.connect("window-opened", (function(_this) {
      return function(wnckScreen, wnckWindow) {
        _this.windows.push(wnckWindow);
        return _this.emit("window-opened", [wnckScreen, wnckWindow]);
      };
    })(this));
    screen.connect("active-window-changed", (function(_this) {
      return function(wnckScreen, wnckWindow) {
        _this.activeWindow = wnckWindow;
        return _this.emit("active-window-changed", [wnckScreen, wnckWindow]);
      };
    })(this));
    screen.connect("active-workspace-changed", (function(_this) {
      return function(wnckScreen, wnckWorkspace) {
        _this.activeWorkspace = wnckWorkspace;
        return _this.emit("active-workspace-changed", [wnckScreen, wnckWorkspace]);
      };
    })(this));
    this.events = {};
  }
